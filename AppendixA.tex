...
\section{\ac{DoD}}
\label{sec:RoughDoD}
Here we display the visualization of \ac{DoD}s for datasets Pezenas and Kobe in Figure~\ref{DoDPezenas}, ~\ref{DoDPezenas-Satellite} and ~\ref{DoDKobe}. The corresponding statistical information is given in Table~\ref{RoughDoDStatistic1}.\\
